            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('${controller.cardSale!.systeminfo.phone}',
                    style: TextStyle(
                        ...
                        children: [
                          GridView.builder(
                            ...
                            gridDelegate: const  SliverGridDelegateWithFixedCrossAxisCount(
                              ...
                              childAspectRatio: 1.0, // نسبة أبعاد العنصر
                            ...
                            itemBuilder: (BuildContext context, int salesIndex) {
                              ...
                              return Card(
                                child: Column(
                                  ...
                                  children: [
                                    CircleAvatar(
                                      radius: 30.0, // حجم الصورة
                                      child: ClipOval(
                                        child: CachedNetworkImage(
                                          imageUrl: salesRep.image,
                                          imageBuilder: (context, imageProvider) => Container(
                                            width: 60.0, // ضعف قيمة الradius لتحديد عرض الـ Container
                                            height: 60.0, // ضعف قيمة الradius لتحديد ارتفاع الـ Container
                                    ...
                                    Expanded( // استخدام Expanded لجعل الContainer يمتد لكامل الارتفاع المتاح
                                      child: Container(
                                        ...
                                        child: Column(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text(salesRep.name, style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                color: Colors.white,
                                                fontSize: Get.width * 0.03
                                            )),
                                            Row(
                                              ...
                                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                              children: [
                                                Text(salesRep.phone, style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.white,
                                                  fontSize: Get.width * 0.025,
                                                )),
                                                FaIcon(FontAwesomeIcons.phone, color: Colors.green, size: Get.width * 0.028,)
                                              ],
                                            )
                                          ],
